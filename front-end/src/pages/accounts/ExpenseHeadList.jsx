...
// Sample expense head data (matching HTML rows)
const initialExpenseHeads = [
...
const ExpenseHeadList = () => {
  // ---------- State ----------
  const [expenseHeads, setExpenseHeads] = useState(initialExpenseHeads);
  ...
  const confirmDelete = () => {
    setExpenseHeads((prev) => prev.filter((h) => h.id !== deleteModal.headId));
