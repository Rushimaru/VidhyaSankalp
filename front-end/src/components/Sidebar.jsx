          ...
          <ul className="sidebar-menu" id="sidebar-menu">
            ...
            <li className={isActive(dashboardItem.path) ? "active-page" : ""}>
              <Link
                ...
                className={isActive(dashboardItem.path) ? "active-menu" : ""}
              >
              ...
              .map((item) => {
                if (item.submenu) {
                  ...
                  return (
                    <li
                      key={item.key}
                      className={`dropdown ${open ? "open" : ""} ${parentActive ? "active-page" : ""}`}
                    >
                      <a
                        href="#!"
                        onClick={(e) => {
                        ...
                        <ul className="sidebar-submenu">
                          {item.submenu.map((sub) => (
                            <li
                              key={sub.path}
                              className={
                                isActive(sub.path) ? "active-page" : ""
                              }
                            >
                              <Link
                                to={sub.path}
                                className={
                                  isActive(sub.path) ? "active-menu" : ""
                                }
                              >
                  ...
                  return (
                    ...
                    >
                      <Link
                        to={item.path}
                        className={isActive(item.path) ? "active-menu" : ""}
                      >
                        <i className={item.icon}></i>
                        <span>{item.label}</span>
                      </Link>
